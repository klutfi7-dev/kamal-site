...
const CTA_COPY: Record<Classification, { heading: string; body: string }> = {
  Pioneer: {
    heading: "Category windows in GCC don't stay open. We'd like to talk before yours closes.",
    body: "An introductory call is the right starting point — to hear about your product, understand your commercial timeline, and confirm whether the window is still yours to define.",
  },
  "Strong Contender": {
    heading: "The field is still small enough for a clear positioning advantage. We'd like to understand yours.",
    body: "An introductory call gives us a chance to hear about your product, your current GCC priorities, and whether our approach is the right fit for where you are.",
  },
  "Contested Contender": {
    heading: "Sharp execution is what separates companies that break through in this category. We'd like to understand what makes yours different.",
    body: "An introductory conversation helps us understand your situation in more depth and gives you an honest sense of whether we are the right people to be involved.",
  },
  Entrant: {
    heading: "The standard approach won't work here. If there's a defensible angle in your product, we'd like to hear it.",
    body: "An introductory call is the right starting point — to understand your specific situation and give you an honest view of whether there is a path that makes commercial sense.",
  },
  "Not Assessed": {
    heading: "We'd like to hear more about your product and your GCC plans.",
    body: "An introductory call is a good place to start — to hear about your product, where you are headed, and see whether there might be a fit.",
  },
};
      ...
      <main className="flex-1 w-full container max-w-4xl mx-auto px-6 py-12 print:py-6 space-y-12">
        ...
        {result.situationSummary && (
          ...
          >
            ...
            <p className="text-lg md:text-2xl font-serif italic text-foreground/90 leading-relaxed pl-5 border-l-2 border-primary/50">
              {result.situationSummary}
            </p>
          </motion.section>
        )}
              ...
              {result.classificationIsEstimated && (
                <div className="mt-1 flex items-start gap-2 rounded-md border border-amber-400/25 bg-amber-500/10 px-4 py-3">
                  ...
                  <p className="text-xs text-amber-300/90 leading-relaxed">
                    This classification is provisional — it's based on an unconfirmed estimate of your competitive density. Before acting on it, it's worth confirming how many direct competitors are active in your specific clinical application in GCC. A discovery call can help clarify the picture.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-7 flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col gap-2 text-center sm:text-left">
                  <span className={`self-center sm:self-start px-3 py-1 rounded-full text-xs font-bold tracking-widest uppercase ${readinessStyle}`}>
            ...
            <div className="bg-card border border-border rounded-xl p-6 max-w-md">
              <div className="flex items-start justify-between mb-5">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">30 minutes with Kamal Lutfi</p>
                </div>
              ...
              <ul className="space-y-2.5 mb-6">
                {[
                  ...
                  "An honest sense of whether there is a fit between your needs and how we work",
                ].map((point, i) => (
